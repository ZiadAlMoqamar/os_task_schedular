...
import 'package:gantt_chart/logic/rr_logic.dart' as rr;
import 'package:flutter/material.dart';

import '../chart.dart';

class RoundRobinUI extends StatefulWidget {
  @override
  _RoundRobinUIState createState() => _RoundRobinUIState();
}

class _RoundRobinUIState extends State<RoundRobinUI> {
  ...
  void generateInput() {
    ...
    for (var i = 0; i < numOfProcesses; i++) {
      input.add(rr.InputProcess(id: i, burstTime: 0));
    }
  }
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    List<rr.InputProcess> victimList = [];
