...
import 'package:gantt_chart/logic/preemp_priority_logic.dart'
    as preemp_priority;
import 'package:flutter/material.dart';

import '../chart.dart';

class PreempPriority extends StatefulWidget {
  @override
  _PreempPriorityState createState() => _PreempPriorityState();
}

class _PreempPriorityState extends State<PreempPriority> {
  ...
  var controllers;
  List<preemp_priority.InputProcess> input = [];
  void generateInput() {
    input = [];
    ...
    for (var i = 0; i < numOfProcesses; i++) {
      input.add(preemp_priority.InputProcess(id: i, burstTime: 0, priority: 0));
    }
  }
  ...
  List<preemp_priority.OutputProcess> output = [];
  @override
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(width: 150, child: Text('Number of processes:')),
                    SizedBox(width: 15),
                    Container(
                      width: 50,
                      height: 50,
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    List<preemp_priority.InputProcess> victimList = [];
                    if (go && numberOfProcesses.text.length != 0) {
                      setState(() {
                        victimList.addAll(input);
                        obj = preemp_priority.PreemptivePriority(
                          input: victimList,
